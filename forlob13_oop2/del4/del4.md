...
3. Desuden er processing faktisk java under "motor-hjelmen" - og det betyder alt faktisk er inde i en stor klasse! Se følgende eksempel: [se her hvordan koden i virkeligheden ser ud](eksempel_processing_java.md)
